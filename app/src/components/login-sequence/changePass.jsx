...
export default function ResetPass() {
  const { setShowResetPass } = useShowPagesContext();
  ...
  return (
    <div className="h-[100vh]">
      ...
      <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-50 bg-[#121B32] rounded-3xl w-[50%] p-5">
        <h1 className="text-white flex flex-row justify-center text-[24px] font-bold py-7">{t('Change Password')}</h1>
        <div className="flex flex-col items-center">
          <form className="flex flex-col items-center w-4/5" action="">
            ...
            <div className="flex flex-col w-full mt-5">
              ...
              {/* Password Inner div */}
              <div className={`flex flex-row items-center justify-between rounded-lg border px-2 py-3 mt-1 ${passMatch ? 'border-[#48516B]' : 'border-red-500 bg-[#f513133d]'}`}>
                <input
                  className="text-[#ACADB1] bg-transparent rounded-lg w-full stroke-none outline-none"
            ...
            <button className="main-yellow w-3/5 mt-12 py-3 rounded-full text-[#0B101D] font-bold">
                {t('Change Password')}
            </button>
          </form>
        </div>
